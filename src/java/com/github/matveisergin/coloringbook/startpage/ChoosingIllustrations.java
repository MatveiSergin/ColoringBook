...
public class ChoosingIllustrations extends JFrame {
    ...
    private JLabel addPictureOnChoosingIllustration(Illustrations illustration) throws IOException {
        JLabel pictures = new JLabel(new ImageIcon(ImageIO.read(new File("C:\\workspace\\mai\\235\\23\\Kursach\\src\\java\\com\\github\\matveisergin\\coloringbook\\media\\" + illustration.name() + ".jpg"))));
