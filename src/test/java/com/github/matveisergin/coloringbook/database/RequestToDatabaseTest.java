...
public class RequestToDatabaseTest {
    ...
    private final String[] NEW_CANVAS_FOR_SAVE = {"name_for_convas", "123456789"};
    private final String[] COLUMN_AND_TABLE_FOR_EXECUTECOUNT = {"id", "ColoringBook"};
    private final String TABLES_NAME = "ColoringBook";
    private final Map<String, String> EXPECTED_RESULT = Map.of(
