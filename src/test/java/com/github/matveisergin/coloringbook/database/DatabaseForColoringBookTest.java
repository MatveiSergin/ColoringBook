...
public class DatabaseForColoringBookTest {
    ...
    private final String[] COLUMNS = {"id", "name", "positionOfColors"};
    private final String SELECT_QUERY_FOR_SELECTALL = """
                SELECT *
                FROM Kursach.TemplatesForColoringBook
                """;
    private final int EXPECTED_SIZE = 2;
    private final Map<Integer, String[]> EXPECTED_RESULT = Map.of(
    ...
    private final String QUERY_INSERT_TUPLE_FOR_TEMPLATES = """
            INSERT INTO Kursach.TemplatesForColoringBook
            (id, name, positionOfColors) VALUES
            (3, 'testing', '123456789');
            """;
    private final String TABLES_NAME_FOR_TEMPLATES = "TemplatesForColoringBook";
    @BeforeEach
    void initDb() {
