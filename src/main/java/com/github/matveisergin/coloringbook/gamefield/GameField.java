...
public class GameField extends JFrame {
    ...
    private static final String PARROT = "Parrot";
    private static final String CHICKEN = "Chicken";
    private Illustration illustration;
    private int width;
    private Action action;
    private static final String START_PROGRESS_VALUE = "Progress: 0%";
    private static final String START_SELECTED_COLOR = "Selected color: ";
    private static final String UNDO = "Undo";
    private static final String EXIT_TO_MENU = "Exit to menu";
    ...
    private static final int[] WINDOW_RESOLUTION = new int[]{900, 750};
